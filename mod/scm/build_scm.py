...
MISSIONS = [
    ...
    # Cortez (9011, spine 9010>=4)
    ("GEN1", [(9011, 1), (9010, 4)], 9036), ("GEN2", [(9011, 2), (9010, 4)], 9037),
    ("GEN3", [(9011, 3), (9010, 4)], 9038), ("GEN4", [(9011, 4), (9010, 4)], 9039),
    ("GEN5", [(9011, 5), (9010, 4)], 9040),
    # Diaz (9012, spine 9011>=5)
    ("BAR1", [(9012, 1), (9011, 5)], 9041), ("BAR2", [(9012, 2), (9011, 5)], 9042),
    ("BAR3", [(9012, 3), (9011, 5)], 9043), ("BAR4", [(9012, 4), (9011, 5)], 9044),
    ("BAR5", [(9012, 5), (9011, 5), (9013, 1)], 9045),
    # Death Row (9013, spine 9012>=4)
    ("KEN1", [(9013, 1), (9012, 4)], 9046),
    ...
    # Vercetti Protection (9016, spine 9012>=5 AND 9013>=1)
    ("PRO1", [(9016, 1), (9012, 5), (9013, 1)], 9052),
    ("PRO2", [(9016, 2), (9012, 5), (9013, 1)], 9053),
    ("PRO3", [(9016, 3), (9012, 5), (9013, 1)], 9054),
    ...
    # Vercetti Finale (9022, spine 9016>=3)
