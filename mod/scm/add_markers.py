...
STRANDS = {
    ...
    "Cortez": [("GEN1", [(9011, 1), (9010, 4)]), ("GEN2", [(9011, 2), (9010, 4)]),
               ("GEN3", [(9011, 3), (9010, 4)]), ("GEN4", [(9011, 4), (9010, 4)]),
               ("GEN5", [(9011, 5), (9010, 4)])],
    "Diaz": [("BAR1", [(9012, 1), (9011, 5)]), ("BAR2", [(9012, 2), (9011, 5)]),
             ("BAR3", [(9012, 3), (9011, 5)]), ("BAR4", [(9012, 4), (9011, 5)]),
             ("BAR5", [(9012, 5), (9011, 5), (9013, 1)])],
    "DeathRow": [("KEN1", [(9013, 1), (9012, 4)])],
    "Avery": [("SER1", [(9014, 1)]), ("SER3", [(9014, 2)]), ("SER2", [(9014, 3)])],
    "Phil": [("PHI1", [(9015, 1)]), ("PHI2", [(9015, 2)])],
    "VercettiProtection": [("PRO1", [(9016, 1), (9012, 5), (9013, 1)]),
                           ("PRO2", [(9016, 2), (9012, 5), (9013, 1)]),
                           ("PRO3", [(9016, 3), (9012, 5), (9013, 1)])],
