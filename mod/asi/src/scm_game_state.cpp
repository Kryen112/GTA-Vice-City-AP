...
constexpr int kPackagesShuffledGlobal = 9858;
...
// global idles).
constexpr int kRadioRandomizedGlobal = 9860;
constexpr int kRadioUnlockBase = 9861;
constexpr int kRadioResolveBase = 9870;
constexpr int kRadioRequestGlobal = 9879;
...
constexpr int kMinimapShuffledGlobal = 9904;
constexpr int kMinimapUnlockGlobal = 9905;
...
// the ending.
constexpr int kFinaleActiveGlobal = 10176;
