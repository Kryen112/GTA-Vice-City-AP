...
// Separates joined lines inside one message, and the labelled segments of the
// status line.
...
// The status line the status key shows: one labelled segment per non-empty list,
