...
// Modified 2026-09-07: complete-packet and explicit TLS APIs.
...
// Optional complete-packet mode: the caller owns AP protocol state while APCc
// owns WebSocket connection, framing, TLS and reconnects. Packets are borrowed.
